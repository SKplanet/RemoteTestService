...
//#define NTE_BUFFER_TOO_SMALL	-1
//#define NTE_INVALID_PARAMETER	-2
//#define NTE_BUFFERS_OVERLAP		-3
//#define NTE_INVALID_HANDLE		-4
//#define NTE_DECRYPTION_FAILURE	-5
//#define NTE_INTERNAL_ERROR		-6
    ...
    public:
        explicit WinAES( const char* lpszContainer=NULL, int nFlags=DEFAULT_FLAGS );
    ...
    protected:
        bool AcquireContext( const char* lpszContainer );
